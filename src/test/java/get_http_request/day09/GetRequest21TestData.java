...
public class GetRequest21TestData extends JsonPlaceHolderUrl {

    //!! amacimiz class 20 dekin i farkli yontemle yapmak

    //test_data packege class actik oraya yaptigimiz classda datalar var bizden bu datalarin testi istenecek
    //bu durumda surekli yazmak yerine classa attik,bilgiler kismini yani degerler kismini degistirmemiz yeterli olacak
